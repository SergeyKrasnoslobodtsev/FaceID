...
namespace ModuleCameraDevices.Extensions
{
    public static class BitmapExtension
    {
        ...
        public static Bitmap RawDataToBitmap(IntPtr scan0, int step, System.Drawing.Size size, Type srcColorType, int numberOfChannels, Type srcDepthType, bool tryDataSharing = false)
        {
            ...
            BitmapData bitmapData = bitmap.LockBits(new Rectangle(System.Drawing.Point.Empty, size), ImageLockMode.WriteOnly, pixelFormat);
        ...
        public static Bitmap ToBitmap(this Mat mat)
        {
            ...
            switch (numberOfChannels)
            {
                case 1:
                    ...
                    if (size.Equals(System.Drawing.Size.Empty))
                    {
                        return null;
                    }
                    if ((size.Width | 3) != 0)
                    {
                        ...
                        bitmap.Palette = GrayscalePalette;
                        BitmapData bitmapData = bitmap.LockBits(new Rectangle(System.Drawing.Point.Empty, size), ImageLockMode.WriteOnly, PixelFormat.Format8bppIndexed);
